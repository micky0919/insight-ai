...
def generate_dataframe(question):
    ...
    #     examples,
    #     # OpenAIEmbeddings(openai_api_key = api_key, openai_api_base='https://api.chatanywhere.cn'),
    #     AzureOpenAIEmbeddings(openai_api_type="azure", openai_api_key = "8ed5c99cc1294837a7aeeee8c823718b", azure_endpoint='https://dscoehkg-openai-weu-for-mis.openai.azure.com/', openai_api_version="2023-05-15", model="text-embedding-3-large"),
    #     FAISS,
    #     k=5,
    #     input_keys=["input"],
    # )
...
with st.sidebar:
    ...
    # selected_max_length = st.sidebar.slider('max_length', min_value=32, max_value=128, value=120, step=8)
